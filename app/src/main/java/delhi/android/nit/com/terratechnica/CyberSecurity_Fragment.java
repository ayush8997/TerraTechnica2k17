...
public class CyberSecurity_Fragment extends Fragment {
    private static final String ARG_PARAM1 = "param1";
    RecyclerView rvEvent;
    private int mParam1;

    public CyberSecurity_Fragment() {
    }


    // TODO: Rename and change types and number of parameters
    public static CyberSecurity_Fragment newInstance(int param1) {
        CyberSecurity_Fragment fragment = new CyberSecurity_Fragment();
    ...
    private class Adater extends RecyclerView.Adapter<Holder> {
        ...
        public void onBindViewHolder(final Holder holder, int position) {
            if (mParam1 == 1) {
                holder.textView2.setText(Data.cyberEvent[position]);
                    ...
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                ...
                                intent.putExtra("type", "cyber_security");
