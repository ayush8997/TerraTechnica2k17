...
public class EventsDataManager {
    ...
    public static void setEventsData() {
        ...
        codeDataManager.add(new EventDetails("NITD PROGRAMMING LEAGUE", "----", "----", 1, "nitd_pl",
        ...
        codeDataManager.add(new EventDetails("REVERSE CODING", "----", "----", 1, "rev_code",
        ...
        codeDataManager.add(new EventDetails("CLASH OF CODES", "----", "----", 2, "coc",
        ...
        codeDataManager.add(new EventDetails("HACKATHON", "----", "----", 2, "hackathon",
        ...
        botDataManager.add(new EventDetails("DEATH RACE", "----", "----", 1, "death_race",
        ...
        botDataManager.add(new EventDetails("CODEMS", "----", "----", 2, "codems",
        ...
        workshopDataManager.add(new EventDetails("DESIGN CUT", "----", "----", 1, "design_cut",
                "INTRO",
        ...
        miscDataManager.add(new EventDetails("UNTANGLE THE TANGLE", "----", "----", 2, "untangle",
