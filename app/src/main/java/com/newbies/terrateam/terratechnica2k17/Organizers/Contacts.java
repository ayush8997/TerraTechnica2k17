package com.newbies.terrateam.terratechnica2k17.Organizers;
...
//        getActivity().getActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        getActivity().findViewById(android.R.id.content).setBackgroundDrawable(getResources().getDrawable(R.drawable.trial));
